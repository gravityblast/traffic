...
func (routerMiddleware *RouterMiddleware) ServeHTTP(w http.ResponseWriter, r *http.Request, nextMiddlewareFunc func() Middleware) (http.ResponseWriter, *http.Request) {
